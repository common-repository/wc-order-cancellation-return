...
/**
 * Class YOOCR_WC_Order_Cancellation_Return_Order_Return_Request_Email
 */
class YOOCR_WC_Order_Cancellation_Return_Order_Return_Request_Email extends WC_Email {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->id             = 'order_return_request';
		$this->title          = __( 'Order return request', 'wc-order-cancellation-return' );
		$this->description    = __( 'Notification emails sent to admin when a return is requested.', 'wc-order-cancellation-return' );

		$this->heading        = __( 'New return request', 'wc-order-cancellation-return' );
		
		// translators: %s is the order number
		$this->subject        = sprintf( __( 'Return requested for order #%s', 'wc-order-cancellation-return' ), '{order_number}' );

		$this->template_base  = plugin_dir_path( __FILE__ ) . '../../woocommerce/';
		$this->template_html  = 'emails/admin-order-return-request.php';
		$this->template_plain = 'emails/plain/admin-order-return-request.php';
